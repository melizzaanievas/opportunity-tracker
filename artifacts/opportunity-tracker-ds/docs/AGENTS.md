# Opportunity Tracker Design System design system
...
workspace package (`@workspace/opportunity-tracker-ds`): other artifacts depend
...
- `SKILL.md` — source-derived design and composition guidance for consumers.
- `docs/references/` — retained source evidence, the active component inventory,
  and one build-reference file per inventoried family. Read the relevant
  reference before changing a cataloged component.
...
`@workspace/opportunity-tracker-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/opportunity-tracker-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/opportunity-tracker-ds` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/opportunity-tracker-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/opportunity-tracker-ds/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/opportunity-tracker-ds/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/opportunity-tracker-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/opportunity-tracker-ds/docs/migrating-expo.md`
