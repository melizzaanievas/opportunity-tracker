# Migrating web UI to Opportunity Tracker Design System

Read `artifacts/opportunity-tracker-ds/docs/AGENTS.md` and
`artifacts/opportunity-tracker-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/opportunity-tracker-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/opportunity-tracker-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/opportunity-tracker-ds/hooks/use-toast`
