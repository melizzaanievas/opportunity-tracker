# Consuming Opportunity Tracker Design System in web apps

Read `artifacts/opportunity-tracker-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/opportunity-tracker-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/opportunity-tracker-ds/styles.css";
```
...
`node_modules/@workspace/opportunity-tracker-ds/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/opportunity-tracker-ds/components/ui/button";
import { cn } from "@workspace/opportunity-tracker-ds/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/opportunity-tracker-ds/hooks/use-toast";
```
...
`@workspace/opportunity-tracker-ds/components/ui/button`. Run the app's typecheck
