# Consuming Opportunity Tracker Design System in Expo apps

Read `artifacts/opportunity-tracker-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/opportunity-tracker-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/opportunity-tracker-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/opportunity-tracker-ds/lib/native-theme";
import { useColors } from "@workspace/opportunity-tracker-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/opportunity-tracker-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/opportunity-tracker-ds/components/native/badge";
import { Button } from "@workspace/opportunity-tracker-ds/components/native/button";
import { Card } from "@workspace/opportunity-tracker-ds/components/native/card";
```
...
Import and render
`@workspace/opportunity-tracker-ds/components/native/button`, then run Expo
