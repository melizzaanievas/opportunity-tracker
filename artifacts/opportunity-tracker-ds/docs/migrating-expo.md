# Migrating Expo UI to Opportunity Tracker Design System

Read `artifacts/opportunity-tracker-ds/docs/AGENTS.md` and
`artifacts/opportunity-tracker-ds/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/opportunity-tracker-ds/lib/native-theme` and
  `@workspace/opportunity-tracker-ds/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/opportunity-tracker-ds/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/opportunity-tracker-ds` and retains only
